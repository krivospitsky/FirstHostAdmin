...
class MailboxesControllerTest < ActionController::TestCase
  ...
  test "should create mailbox" do
    assert_difference('Mailbox.count') do
      post :create, mailbox: { domain_id: @mailbox.domain_id, gid: @mailbox.gid, password: @mailbox.password, uid: @mailbox.uid, user_name: @mailbox.user_name }
    end
  ...
  test "should update mailbox" do
    put :update, id: @mailbox, mailbox: { domain_id: @mailbox.domain_id, gid: @mailbox.gid, password: @mailbox.password, uid: @mailbox.uid, user_name: @mailbox.user_name }
    assert_redirected_to mailbox_path(assigns(:mailbox))
  end
